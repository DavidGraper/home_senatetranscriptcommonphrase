...
class NGramEvaluate:
    ...
    def bigramtestsentence(self, transline, percentcutoff):
        ...
        sentencengrams = self.breakintotrigrams(sentencewords, 3)
        ...
        for sentencengram in sentencengrams:
            ...
            sentencebigramtext = "{0} {1}".format(sentencengram[0], sentencengram[1])
            sentencenextword = sentencengram[2]

            # print("***")
            # print("Seeking trigram: '{0}'".format(sentencetrigramtext))
            # print("with nextword: '{0}'".format(sentencenextword))

            ngramdistribution = self.sdb.gettrigraminfo(sentencebigramtext)
